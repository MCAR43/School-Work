...
public:
    ...
    int mmax(Move & bestMove, Bitboard & _game, int depth, bool maximizer, int alpha, int beta);
    int min(Move & best, int depth, int qui_depth, Bitboard & state, int alpha, int beta, std::chrono::high_resolution_clock::time_point t1, const double maxTime);
    int max(Move & best, int depth, int qui_depth, Bitboard & state, int alpha, int beta, std::chrono::high_resolution_clock::time_point t1, const double maxTime);
