...
N_ARITHLOGIC_EXPR | N_IF_EXPR | N_LET_EXPR | N_LAMBDA_EXPR | N_PRINT_EXPR | N_INPUT_EXPR | N_EXPR_LIST;

N_ARITHLOGIC_EXPR :
N_UN_OP N_EXPR | N_BIN_OP N_EXPR N_EXPR;

N_IF_EXPR :
T_IF N_EXPR N_EXPR N_EXPR {
	printRule("IF_EXPR", "if");
};

N_LET_EXPR :
T_LETSTAR T_LPAREN N_ID_EXPR_LIST T_RPAREN N_EXPR {
	printRule("LET_EXPR", "let*");
};
...
/* epsilon */ {
	...
	printRule("ID_EXPR_LIST", "IDENT");
};

N_LAMBDA_EXPR :
T_LAMBDA T_LPAREN N_ID_LIST T_RPAREN N_EXPR {
	printRule("LAMBDA_EXPR", "lambda");
};
