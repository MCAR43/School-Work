...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        if (visibility == 8) {
            ViewPropertyAnimatorCompat anim = ViewCompat.animate(this.mToolbar).alpha(0.0f);
            ...
            ViewPropertyAnimatorCompat anim2 = ViewCompat.animate(this.mToolbar).alpha(1.0f);
            anim2.setDuration(duration);
            anim2.setListener(new ViewPropertyAnimatorListenerAdapter() {
