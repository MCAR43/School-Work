...
class AlertController {
    ...
    private void setupView() {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mContext, (AttributeSet) null, R.styleable.AlertDialog, R.attr.alertDialogStyle, 0);
        boolean z = setupTitle((ViewGroup) this.mWindow.findViewById(R.id.topPanel));
